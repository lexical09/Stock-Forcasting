...
# The dependencies include 
	...
	# pandas_datareader for pandas to access remote data 
	# pytrends for Google trend data
	# fix_yahoo_finance 

	# To install the dependencies 
	# pip3 install -U numpy pandas pandas_datareader fbprophet matplotlib pytrends pystan fix_yahoo_finance


import pandas as pd
pd.core.common.is_list_like = pd.api.types.is_list_like #bypass the version control of package manager(pip)
import datetime
import numpy as np
import fbprophet
import pytrends
...
class Stocker():
    ...
    def __init__(self, ticker):
        ...
        try:
            ...
            #stock = web.get_data_yahoo('%s', '2000-01-01', '2018-07-05' % (ticker))
        ...
        if ('Adj Open' not in stock.columns):
